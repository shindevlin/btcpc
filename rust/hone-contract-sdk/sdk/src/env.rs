...
pub(crate) mod sys {
    extern "C" {
        ...
        // Returns attached deposit in hunits, capped at u64::MAX.
        ...
        // Balance / transfer — amounts in hunits (u64, max ~18.4 × 10^18).
...
/// Returns the attached deposit in hunits.
...
/// Transfer `amount` hunits from the contract's own balance to `to`.
/// Returns true on success; returns false if insufficient funds.
/// Amount is capped at u64::MAX hunits; amounts above that return false.
...
/// Amount is in hunits and capped at u64::MAX.
pub fn promise_create(
    contract: &str,
    method: &str,
    args: &[u8],
