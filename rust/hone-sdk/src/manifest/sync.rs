...
fn render_doc(m: &Manifest, diff: Option<&ManifestDiff>, lock: &LockFile) -> String {
    ...
    s.push_str("<!-- HoneMesh.md — how this repo uses HoneMesh. GENERATED by `hone sync`.\n");
    ...
    s.push_str(&format!(
        "---\n_Generated from HoneMesh {} surface `{}`. Re-run `hone sync` after pulling HoneMesh updates._\n",
        m.hone_version,
