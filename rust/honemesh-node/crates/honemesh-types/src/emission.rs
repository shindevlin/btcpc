...
//! |-----|-----------|---------------------------|-----------|
//! |  0  | 30s       | 5,760 HONE/day           | ~4 years  |
//! |  1  | 60s       | 2,880 HONE/day           | ~8 years  |
//! |  2  | 2 min     | 1,440 HONE/day           | ~16 years |
//! |  3  | 4 min     | 720 HONE/day             | ~32 years |
//! |  4  | 8 min     | 360 HONE/day             | ~64 years |
...
/// Doubles each era: era 0 = 0.001 HONE, era 1 = 0.002 HONE, era 2 = 0.004 HONE …
#[inline]
...
/// Minimum bond a runtime owner must post on RuntimeRegister (5 HONE).
/// Held in escrow while the runtime is active; partially or fully slashed on misbehaviour.
pub const RUNTIME_MIN_BOND: u64 = 5 * 10_000_000_000; // 5 HONE in hunits
...
/// Minimum stake for a non-trivial stake multiplier (100 HONE).
/// stake_weight = min(isqrt(stake / MIN_STAKE), 10); bootstrap floor = 1.
pub const MIN_STAKE: u64 = 100 * 10_000_000_000; // 100 HONE in hunits
...
///
/// Derivation:
///   Starting fund:  840,000 HONE (124 years × 0.04 HONE/epoch rounding)
