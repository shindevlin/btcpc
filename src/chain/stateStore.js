    ...
    case "SENSOR_REGISTER":
      if (entry.sensor_data && entry.sensor_data.sensor_id) {
        ...
        var sensorRecord = Object.assign(existingSensor, {
          ...
          posting_key: ssd.posting_key || existingSensor.posting_key || null,
          posting_key_hash: ssd.posting_key_hash || existingSensor.posting_key_hash || null,
          hardware_owner: ssd.hardware_owner || existingSensor.hardware_owner || ssd.owner || from,
          hardware_takeover_token: ssd.hardware_takeover_token || existingSensor.hardware_takeover_token || null,
          hardware_takeover_usd: ssd.hardware_takeover_usd || existingSensor.hardware_takeover_usd || null,
          hardware_takeover_tx_hash: ssd.hardware_takeover_tx_hash || existingSensor.hardware_takeover_tx_hash || null,
    ...
    case "GATEWAY_REGISTER":
      if (entry.gateway_data && entry.gateway_data.gateway_id) {
        ...
        gateways.set(sgd.gateway_id, Object.assign(existingGateway, {
          ...
          posting_key: sgd.posting_key || existingGateway.posting_key || null,
          posting_key_hash: sgd.posting_key_hash || existingGateway.posting_key_hash || null,
          hardware_owner: sgd.hardware_owner || existingGateway.hardware_owner || sgd.owner || from,
          hardware_takeover_token: sgd.hardware_takeover_token || existingGateway.hardware_takeover_token || null,
          hardware_takeover_usd: sgd.hardware_takeover_usd || existingGateway.hardware_takeover_usd || null,
          hardware_takeover_tx_hash: sgd.hardware_takeover_tx_hash || existingGateway.hardware_takeover_tx_hash || null,
