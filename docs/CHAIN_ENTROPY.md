...
- `rust/honemesh-node/crates/honemesh-types/src/emission.rs` — `LIVENESS_REWARDS_ENABLED`, `ENTROPY_DECAY_ENABLED`
- `rust/honemesh-node/crates/honemesh-types/src/entry.rs` — `LivenessProof`, `EntropyWitness`
